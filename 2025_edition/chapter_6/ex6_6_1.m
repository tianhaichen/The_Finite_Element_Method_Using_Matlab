...
%       isoparametric four-node quadrilateral element and Guass-Legendre
...
xcoord = [-1 1 1 -1];
ycoord = [-0.75 -0.75 1.25 0.25];   % x,y coordinate values
...
for intx = 1:nglx
    x=point2(intx,1);
    wtx=weight2(intx,1);        % sampling point,weight in x-axis
    for inty = 1:ngly
       y=point2(inty,2);
