...
%
% Problem description                                                        
%   Find the dynamic behavie of a bar structure           
%   as shown in Fig. 7.6.1,subjected to a step force function at the right end.
%                                                                            
...
for i=1:nnode
    gcoord(i,:) = i-1;   % x,y coordinates of nodes
end
